...
sha_base=`sha1sum results/250530_test/250521_g16_min_5000_a0000005/10000/250530_pm/info.csv`
sha=`sha1sum results/250530_base/250521_g16_min_5000_a0000005/10000/250530_pm/info.csv`
sha_base=${sha_base% *}
sha=${sha% *}
