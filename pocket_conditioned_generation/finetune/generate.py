...
from src.utils import set_random_seed, logend
...
def generate(args: Namespace, rdir: str, fdir: str, model_path: str):
    ...
    with logend(logger, 'Prepare data'):
        ...
        ## CD
        data = CDDataset(f"{WORKDIR}/cplm/preprocess/results/finetune/r4_all", fargs.seed, random_rotate=False, mol_atom_h=True, mol_coord_h=True, 
